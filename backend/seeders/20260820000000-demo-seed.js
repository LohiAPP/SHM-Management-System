...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('users', [
      { id: uuidv4(), employee_id: adminEmpId, email: 'admin@shm.com', password_hash: '$2b$10$TNTNTGMNGHlzpF6sWKEFb.ou9ru6CSQOcNxV6EaYZ6Lr0fniM3zj6', role: 'ADMIN', created_at: new Date(), updated_at: new Date() },
      { id: uuidv4(), employee_id: hodEmpId, email: 'hod@shm.com', password_hash: '$2b$10$TNTNTGMNGHlzpF6sWKEFb.ou9ru6CSQOcNxV6EaYZ6Lr0fniM3zj6', role: 'HOD_MANAGER', created_at: new Date(), updated_at: new Date() },
      { id: uuidv4(), employee_id: empEmpId, email: 'worker@shm.com', password_hash: '$2b$10$TNTNTGMNGHlzpF6sWKEFb.ou9ru6CSQOcNxV6EaYZ6Lr0fniM3zj6', role: 'EMPLOYEE', created_at: new Date(), updated_at: new Date() }
    ]);
