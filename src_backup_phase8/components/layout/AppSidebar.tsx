...
export const AppSidebar: React.FC = () => {
  ...
  const navItems = [
    { to: role === 'ADMIN' ? '/' : role === 'MANAGER' || role === 'HOD' ? '/manager' : '/employee', icon: <LayoutDashboard size={20} />, label: 'Dashboard', roles: ['ADMIN', 'HOD', 'MANAGER', 'ENGINEER', 'TECHNICIAN'] },
    { to: '/projects', icon: <Briefcase size={20} />, label: 'Projects', roles: ['ADMIN', 'HOD', 'MANAGER'] },
    { to: '/tasks', icon: <CheckSquare size={20} />, label: 'Tasks', roles: ['ADMIN', 'HOD', 'MANAGER', 'ENGINEER', 'TECHNICIAN'] },
    ...
    { to: '/calendar', icon: <Calendar size={20} />, label: 'Calendar', roles: ['ADMIN', 'HOD', 'MANAGER', 'ENGINEER', 'TECHNICIAN'] },
    { to: '/additional-time', icon: <Clock size={20} />, label: 'Additional Time', roles: ['ADMIN', 'HOD', 'MANAGER', 'ENGINEER', 'TECHNICIAN'] },
    { to: '/my-work-timer', icon: <Timer size={20} />, label: 'My Work Timer', roles: ['ENGINEER', 'TECHNICIAN'] },
  ];
